...
void Append::setup()
{
    ...
    _myName = "Append";
    _myDesc = "Append two tables. B input is first, A is second.";
}

void Append::description(QString name, QString desc)
{
    setup();
}
...
QString Append::description()
{
    ...
    return QString("Merge/Append;Append two tables. B input is first, A is second./2");
}


void Append::knobs(Knob_Callback *f)
{
...
bool Append::contains(QStandardItemModel* mod, QList<QStandardItem *> list)
{
